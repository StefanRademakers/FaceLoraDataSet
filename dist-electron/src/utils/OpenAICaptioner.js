...
high-quality caption describing the visual features of the person, facial features, clothing and their setting - suitable for LoRA training. 
...
Only return the caption. Do not include any explanation or punctuation outside the caption itself.`;
    ...
    async generateLoraCaption(imagePath, token, enableCaching = false) {
        ...
        const hash = crypto_1.default.createHash('md5').update(imagePath + '|' + token).digest('hex');
